function [kspace,averages]=fill_kspace3Dp2roud(raw,includewindow,nr_of_card_frames,nr_of_resp_frames,nr_dynamics,dimz,dimy,nr_ksteps,dimx,card_bin_ass,resp_bin_ass,traj,centric)
...
% trajectory for 3D p2roud acqusition
