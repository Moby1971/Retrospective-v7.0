function amplitude = extractnavigator3D_PCA(inputdata,navigatorlength,nr_nav_points,posneg)
...
navdata_amplitude = reshape(permute(inputdata,[2,3,1,4]),nr_rep*dimy*dimz,dimx);
